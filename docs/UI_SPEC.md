...
- 最小窗口：`848 × 756`。该下限由活动页卡片的最小尺寸决定——正方形卡片最小为 `--card-min`（280px），仪表盘网格需要 `2×280+15=575px` 内容宽；加页面壳左右 padding（68px）与侧边栏（205px）得最小宽 848，加页头/运行时条得最小高 756。到达该尺寸后窗口与网格都不再收缩，长方形卡（速率、流量）随列宽等比例伸缩。
