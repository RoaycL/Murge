/**
 * LEGACY elevation COM flow — kept only as reviewed audit-trail code and
 * unit-tested evidence of the superseded Phase 9 design. NO production path
 * imports this module; do not wire it without a new reviewed design change.
 */
